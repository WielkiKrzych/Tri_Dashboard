...
if uploaded_file is not None:
    ...
    with tab_intelligence:
        ...
        with t4: render_tab_content("trends")
    ...
    with tab_physiology:
        ...
        with t5: render_tab_content("vent_thresholds", df_plot, training_notes, uploaded_file.name, cp_input, w_prime_input, rider_weight, max_hr)
