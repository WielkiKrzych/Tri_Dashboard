...
def create_hysteresis_data():
    ...
    Ramp Down: Fatigue causes VT1 to appear earlier/lower power. Say at 170W.
    """
...
def test_hysteresis():
    """Test VT hysteresis detection in ramp up/down protocol."""
